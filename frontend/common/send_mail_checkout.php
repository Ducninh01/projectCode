...
function sendMailCheckout($getName, $getEmail, $getPhone, $address, $currentDatetime, $sessionSavecard)
{
    $productName = '';
    $productPrice = '';
    $productQuantity = '';
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'Congratulations on your successful purchase';
    ...
    <head>
        ...
        <title>Order Notification | Shop Anbico</title>
    </head>
        ...
        <div class="container-fluid">
            <div class="container" style="background-color: #e7eff8; width: 600px; margin: auto;">
                <div class="col-12 mx-auto" style="width: 580px;  margin: 0 auto;">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row mt-5" style="margin-top: 35px; display: flex;">
                                <div class="col-6"
                                    ...
                                    <br>
                                    <span>
                                        <a style="color: white !important;" href="mailto:' . $getEmail . '}}"
                                            target="_blank">' . $getEmail . '</a>
                                    </span>
                                    <br>
                                    <span>' . $getPhone . '</span>
                                </div>
                                <div class="col-6" style="flex: 0 0 50%; width: 50%; box-sizing: border-box;">
                                    <b>Order date:</b> ' . $currentDatetime . '
                                    <br>
                                    <b>Address:</b> ' . $address . '
                                </div>
                            </div>
                    ...
                    $strproduct = '';
                    foreach ($sessionSavecard as $product) {
                 ...
                 <div class="col-12 p-0">
                    ...
                    <table class="mt-2 w-100"
                       ...
                       <tr>
                          ...
                          <td class="pr-3 text-right" style="text-align: right; padding-right: 20px;">
                             $' . number_format($countMoney) . '
                          </td>
                       </tr>
                       <tr style="font-size: 18px;">
                          <td><b>TOTAL</b></td>
                          <td class="pr-3 text-right" style="text-align: right; padding-right: 20px;">
                             <b>$' . number_format($countMoney) . '</b>
                          </td>
                       </tr>
                    </table>
                 </div>
           ...
           <div class="container-fluid">
              ...
              <div class="row pl-3 py-2" style="background-color: #fff; padding: 10px 20px;">
                 <p>You can check the appearance of the product (brand, model, color, quantity,...) before
                    ...
                    electrical-electronic device or try the product.
                 </p>
...
';
        ...
        $email_template = $str1 . '' . $strproduct . '' . $str2;
