...
<body>
    ...
    $stmt = $conn->prepare("SELECT * FROM products WHERE active = " . ACTIVE . " ORDER BY sort_order ASC LIMIT ?, ?");
    ...
    <div class="single-product-area">
        ...
        <div class="container">
            <div class="row">
                ...
                $querySql = "SELECT * FROM products WHERE active =" . ACTIVE . " ";
                                ...
                                <ul class="pagination">
                                    ...
                                    if ($totalRecord > $numPage) {
                                        for ($i = 1; $i <= $totalPage; $i++) {
                                            ...
                                            if ($getPgaeUrl == $i) {
                                                echo '   <li class="active"><a href="shop.php?page=' . $i . '" class="active">' . $i . '</a></li>';
                                            } else {
