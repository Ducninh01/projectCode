    ...
    <div class="single-product-area">
        ...
        <div class="container">
            <div class="row">
                ...
                $querySql = "SELECT * FROM products WHERE is_new =" . ACTIVE . " AND active =" . ACTIVE . " ";
                        ...
                        <div class="product-pagination text-center">
                            <nav>
                                <ul class="pagination">
                                    ...
                                    ?>
                                        <li>
                                            <a href="top_new.php?page=<?php echo ($page - 1) ?>" aria-label="Previous">
                                    ...
                                    if ($totalRecord > $numPage) {
                                        for ($i = 1; $i <= $totalPage; $i++) {
                                            ...
                                            if ($getPgaeUrl == $i) {
                                                echo '   <li class="active"><a href="top_new.php?page=' . $i . '" class="active">' . $i . '</a></li>';
                                            } else {
                                                echo '<li><a href="top_new.php?page=' . $i . '">' . $i . '</a></li>';
                                            }
                                        }
                                    } else {
                                        echo '';
                                    ...
                                    ?>
                                        <li>
                                            <a href="top_new.php?page=<?php echo ($page + 1) ?>" aria-label="Next">
