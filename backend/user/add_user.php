    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($errors)) {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                //Encrypt password and insert value in the table users
                $passwordMd5 = md5($password);
                $stmtInsert = mysqli_prepare($conn, "INSERT INTO users (`username`,`email`,`password`,`active`) VALUES (?,?,?,?)");
                mysqli_stmt_bind_param($stmtInsert, "ssss", $userName, $email, $passwordMd5, $active);
                                ...
                                <div class="tab-pane" id="formcontrols">
                                    <form id="" class="form-horizontal" method="POST">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span6" id="user_name" name="user_name" value="<?php echo (isset($userName)) ? $userName : ''; ?>">
